...
const perfil = () => {
  const [ newdatos_personales, setNewDatos_personales] = useState({
    codigo: "",
    url: "",
    nombre: "",
    apellido: "",
  ...
  const validate = () => {
    const errors = {}
    if (!newdatos_personales.nombre) errors.nombre = "Se requiere nombre"
    return errors
  }
  ...
  const handleSubmit = async (e) => {
    ...
    await createDatos_personales()
  };


  const createDatos_personales = async () => {
    try {
        await fetch("/api/dato", {
        method: "POST",
        headers: {
          "Content-Type": "application/json"
        },
        body: JSON.stringify(newdatos_personales)
      })
    } catch (error) {
      cpmsole.error(error)
    }
  ...
  const handleChange = (e) =>
    setNewDatos_personales({ ...newdatos_personales, [e.target.id]: e.target.value })
                  ...
                  <div className="space-y-1 text-center">
                    ...
                    <div className="flex text-sm text-gray-600">
                      ...
                      >
                        ...
                        <input id="migratorios" onChange={handleChange} name="file-upload" type="file" className="sr-only" />
                      </label>
